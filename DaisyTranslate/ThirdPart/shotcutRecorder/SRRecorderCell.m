...
//            snapBackArrow drawAtPoint: [self _snapbackRectForFrame: cellFrame].origin fromRect: NSMakeRect(0, 0, snapBackArrow.size.width, snap) operation:<#(NSCompositingOperation)#> fraction:<#(CGFloat)#>
